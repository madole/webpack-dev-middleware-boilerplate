...
webpackBaseConfig =
    ...
    output:
        ...
        devtoolModuleFilenameTemplate: 'webpack:///node_modules/mi9-social/[resource-path]'
    module:
        preLoaders: [
            test: /mi9(.*)\.js$/
            loader: 'source-map'
...
webpackTestsConfig.entry =
    'tests/comment.spec': 'src/tests/comment.spec.coffee'
    'tests/gigya.spec': 'src/tests/gigya.spec.coffee'
    'tests/share.spec': 'src/tests/share.spec.coffee'
